...
# 3. Структура решения
- `Bank` – библиотека классов (консольное приложение, преобразованное в библиотеку).
  - `BankAccount.cs` – основной класс.
- `BankTests` – проект модульных тестов.
  - `BankAccountTests.cs` – набор тестовых методов.
- `Report` - папка с файлом Report.md.
  - `Report.md` - сопроводительная записка.
